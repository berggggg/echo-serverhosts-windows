...
8. Download the server monitor to auto-restart in the event of a crash [here](https://github.com/marshmallow-mia/Echo-VR-Server-Error-Monitoring). Edit the file and customize it before running. 
